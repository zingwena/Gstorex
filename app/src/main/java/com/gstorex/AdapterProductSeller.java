...
public class AdapterProductSeller extends RecyclerView.Adapter<AdapterProductSeller.HolderProductSeller> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull HolderProductSeller holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                detailBottomSheet(modelProduct); // here the model contains details of clicked product
            }
    ...
    private void detailBottomSheet(ModelProduct modelProduct) {
        ...
        if (discountAvailable.equals("true")) {
            ...
            originalPriceTv.setPaintFlags(originalPriceTv.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG); //add strike through orginal price
                ...
                builder.setTitle("Delete")
                        ...
                        .setPositiveButton("DELETE", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                //delete
                                deleteProduct(id); //id id the product id
